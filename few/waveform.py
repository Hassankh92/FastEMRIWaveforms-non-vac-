...
class GenerateEMRIWaveform:
    ...
    def __init__(
        ...
        if "equatorial" in self.waveform_generator.descriptor: # this line added to be compatible with Kerr case
            self.args_remove.append(5)
    ...
    def stock_waveform_options(self):
        print(
            ...
            Pn5AAKWaveform
            RelativisticKerrCircularFlux
            Disk_Kerr_AAK_Waveform
            Axion_RelativisticKerrCircularFlux
            Rel_Axion_RelativisticKerrCircularFlux
            Disk_RelativisticKerrCircularFlux
...
class RelativisticKerrCircularWaveformBase(KerrCircular, ParallelModuleBase, ABC):

    def attributes_RelativisticKerrCircularWaveformBase(self):
        """
        attributes:
            inspiral_generator (obj): instantiated trajectory module.
            amplitude_generator (obj): instantiated amplitude module.
            ...
            mode_selector (obj): instantiated mode selection module.
            num_teuk_modes (int): number of Teukolsky modes in the model.
            ls, ms, ns = 0 (1D int xp.ndarray): Arrays of mode indices :math:`(l,m,n)`
                after filtering operation. If no filtering, these are equivalent
                to l_arr, m_arr, n_arr = 0.
            xp (obj): numpy or cupy based on gpu usage.
            num_modes_kept (int): Number of modes for final waveform after mode
                selection.
...
class KerrCircularFlux(RelativisticKerrCircularWaveformBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        RelativisticKerrCircularWaveformBase.__init__(
            self,
            EMRIInspiral,
            Interp2DAmplitudeKerrCircular,
            InterpolatedModeSumKerrCircular,
            inspiral_kwargs=inspiral_kwargs,
            amplitude_kwargs=amplitude_kwargs,
            sum_kwargs=sum_kwargs,
            Ylm_kwargs=Ylm_kwargs,
...
class MigrationTorqueKerrCircularFlux(RelativisticKerrCircularWaveformBase):
...
class ScalarCloudKerrCircularFlux(RelativisticKerrCircularWaveformBase):
