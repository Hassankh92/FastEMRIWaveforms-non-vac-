...
// Here it is trying to read the amplitude row in way that it stores from small distance to large distance, but my data is already in an increasing order in "r" itself. So 
