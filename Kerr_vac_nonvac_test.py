...
from few.waveform import SchwarzschildEccentricWaveformBase, KerrCircRelativisticWaveformBase
...
from few.summation.interpolatedmodesum import InterpolatedModeSum, CubicSplineInterpolant, InterpolatedModeSumKerrCirc
...
# print("Migration traj ran",traj_migration,"\n")
# traj_cloud = EMRIInspiral(func="CloudKerrCircFlux")
# print("Cloud traj ran",traj_cloud,"\n")
...
e0 = 0.0
# schw_result = traj_few(M,mu,a0,p0,e0,Y0,T=T, dt=dt)
# print("Schw final time: ", schw_result[0][-1]/YRSID_SI)
# print("Schw final p: ", schw_result[1][-1])
...
# print("Kerr final time: ", t_Kerr[-1]/YRSID_SI, "Migration final time: ", t_migration[-1]/YRSID_SI, "Cloud final time: ", t_cloud[-1]/YRSID_SI)

# # print("Kerr final time: ", t_Kerr[-1]/YRSID_SI)
